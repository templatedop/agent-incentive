...
import (
	...
	"gitlab.cept.gov.in/it-2.0-common/n-api-server/response"
...
func (c *Context) fromGinCtx(ginCtx *gin.Context) {
	...
	// Propagate request headers into context for downstream use
	cc = context.WithValue(cc, "RequestHeaders", ginCtx.Request.Header)
