...
import (
    "gitlab.cept.gov.in/it-2.0-common/n-api-server/router-adapter"
    _ "gitlab.cept.gov.in/it-2.0-common/n-api-server/router-adapter/gin" // Import desired adapter
)
...
```go
import (
    _ "gitlab.cept.gov.in/it-2.0-common/n-api-server/router-adapter/gin"
    _ "gitlab.cept.gov.in/it-2.0-common/n-api-server/router-adapter/fiber"
    _ "gitlab.cept.gov.in/it-2.0-common/n-api-server/router-adapter/echo"
    _ "gitlab.cept.gov.in/it-2.0-common/n-api-server/router-adapter/nethttp"
)
```
...
import (
    ...
    ginAdapter "gitlab.cept.gov.in/it-2.0-common/n-api-server/router-adapter/gin"
)
