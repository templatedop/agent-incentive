...
import (
	...
	healthcheck "gitlab.cept.gov.in/it-2.0-common/api-healthcheck"
	...
	health "gitlab.cept.gov.in/it-2.0-common/n-api-server/health"
	"gitlab.cept.gov.in/it-2.0-common/n-api-server/middlewares"
	prof "gitlab.cept.gov.in/it-2.0-common/n-api-server/pprof"
	"gitlab.cept.gov.in/it-2.0-common/n-api-server/ratelimiter"
	rate "gitlab.cept.gov.in/it-2.0-common/n-api-server/ratelimiter"
	"gitlab.cept.gov.in/it-2.0-common/n-api-server/route"
	"gitlab.cept.gov.in/it-2.0-common/n-api-server/util/slc"
...
// registerHealthCheckProbes registers health check probes
func registerHealthCheckProbes(app *gin.Engine, cfg *config.Config, Checker *healthcheck.Checker) {
...
func Defaultgin(ctx context.Context, cfg *config.Config, osdktrace *otelsdktrace.TracerProvider, MetricsSet *metrics.Set, Checker *healthcheck.Checker, registries []*registry) *Router {
	...
	registerHealthCheckProbes(app, cfg, Checker)
